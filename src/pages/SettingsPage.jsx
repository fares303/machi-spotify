...
export default function SettingsPage() {
  ...
  return (
    <motion.div initial={{opacity:0,y:12}} animate={{opacity:1,y:0}} className="p-6 pb-12 max-w-2xl">
      ...
      {/* About */}
      <div className="mt-8 text-center" style={{color:'var(--color-on-surface-muted)'}}>
        <p className="text-sm font-display font-bold gradient-text">Machi Spotify v2.0</p>
        <p className="text-xs mt-1">No ads · No login · Open source spirit</p>
        <p className="text-xs mt-1">Streams from YouTube · No music stored on server</p>
      </div>
    </motion.div>
  )
}
